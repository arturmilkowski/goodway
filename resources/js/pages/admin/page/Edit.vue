                ...
                <form @submit.prevent="form.put(update(props.page?.id).url)">
                    <FieldSet>
                        <FieldGroup>
                            ...
                            <!-- Zakładki języków -->
                            <!-- Tabs tylko wizualnie — panele renderowane przez v-show -->
                            <!-- żeby edytor WYSIWYG nie tracił zawartości -->
                            <Tabs
                            ...
                            >
                                ...
                                <!-- Panele z v-show zamiast TabsContent -->
                                <div
                                    v-for="locale in props.locales"
                                    :key="locale"
                                ...
                                >
                                    ...
                                    <Field>
                                        <FieldLabel :for="`content-${locale}`"
                                            >Zawartość podstrony</FieldLabel
                                        >
                                        <Editor
                                            :id="`content-${locale}`"
                                            v-model="
                            ...
                            <Field>
                                <div class="flex items-center gap-3">
                                    ...
                                    <FieldLabel for="navbar"
                                        >Umieść w menu głównym</FieldLabel
                                    >
                                </div>
                            </Field>
