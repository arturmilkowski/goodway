...
@forelse ($posts as $post)
            <article class="flex flex-col hover:bg-zinc-50">
                <h2 class="border-t border-l border-r border-black px-4 pt-2 text-xs sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">
